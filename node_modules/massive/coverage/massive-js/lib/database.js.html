...
<html lang="en">
<head>
    <title>Code coverage report for massive-js/lib/database.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">massive-js/lib</a> database.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">99.22% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>127/128</span>
      </div>
      <div class='fl pad1y space-right2'>
...
334
335
336</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">3007x</span>
<span class="cline-any cline-yes">3007x</span>
<span class="cline-any cline-yes">3007x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3007x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3007x</span>
<span class="cline-any cline-yes">2187x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3007x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1332x</span>
<span class="cline-any cline-yes">27795x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
const Massive = function (connection, loader = <span class="branch-0 cbranch-no" title="branch not covered" >{},</span> driverConfig = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
  this.loader = loader;
...
&nbsp;
  return this.query(`DROP TABLE IF EXISTS ${table} ${cascade ? "CASCADE" : <span class="branch-1 cbranch-no" title="branch not covered" >""}</span>;`)
    .then(() =&gt; {
      this.detach(table);
    });
};
...
Massive.prototype.dropSchema = function(schemaName, options={}) {
  return this.query(`DROP SCHEMA IF EXISTS ${schemaName} ${options.cascade ? "CASCADE" : ""};`)
    .then(() =&gt; {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this[schemaName]) {
