...
<html lang="en">
<head>
    <title>Code coverage report for massive-js/lib/queryable.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">massive-js/lib</a> queryable.js
    </h1>
    <div class='clearfix'>
 ...
 * predicate, or raw primary key value.
 ...
 *
 * @param {Object|String} [criteria] - A criteria object, prebuilt predicate,
 * or raw ID value.
 * @param {Object} [options] - Query options.
 * @return {Promise} Query results.
 */
...
&nbsp;
  ...
  if (options.document) {
    ...
    if (plan.fields.length === 1) {
      tsv = plan.fields[0];
      <span class="missing-if-branch" title="else path not taken" >E</span>if (tsv.indexOf('&gt;&gt;') === -1) {
...
&nbsp;
  if (plan.where) {
    const searchWhere = where(plan.where, 1, options.document ? 'docGenerator' : 'generator');
&nbsp;
 ...
 * @return {Promise} Query results.
 */
Queryable.prototype.where = function(conditions, params = <span class="branch-0 cbranch-no" title="branch not covered" >[])</span> {
