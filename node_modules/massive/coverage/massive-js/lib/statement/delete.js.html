...
<html lang="en">
<head>
    <title>Code coverage report for massive-js/lib/statement/delete.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">massive-js/lib/statement</a> delete.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  sql += `${this.source.delimitedFullName} WHERE ${this.where.conditions} RETURNING *`;
&nbsp;
  return sql;
};
&nbsp;
