...
<html lang="en">
<head>
    <title>Code coverage report for massive-js/lib/statement/where.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">massive-js/lib/statement</a> where.js
    </h1>
    <div class='clearfix'>
...
const generator = function (condition) {
  ...
  } else <span class="missing-if-branch" title="else path not taken" >E</span>if (condition.value) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (result.params) { conjunction.params = conjunction.params.concat(result.params); }
&nbsp;
    return conjunction;
  }, {
    params: [],
