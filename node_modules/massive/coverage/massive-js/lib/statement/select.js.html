...
<html lang="en">
<head>
    <title>Code coverage report for massive-js/lib/statement/select.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">massive-js/lib/statement</a> select.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  _.castArray(options.fields || []).forEach((f) =&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (options.document) {
<span class="cstat-no" title="statement not covered" >      this.fields.push(parseKey(`body.${f}`).field);</span>
    }
&nbsp;
