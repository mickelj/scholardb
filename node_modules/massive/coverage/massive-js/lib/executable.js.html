...
<html lang="en">
<head>
    <title>Code coverage report for massive-js/lib/executable.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">massive-js/lib</a> executable.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    if (this.singleValue) {
      try {
        data = _.isArray(data) ? <span class="branch-0 cbranch-no" title="branch not covered" >data.map(singleValue):</span> singleValue(data);
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        return this.db.instance.$config.promise.reject(e);</span>
      }
    }
&nbsp;
    return data;
