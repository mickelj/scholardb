...
<html lang="en">
<head>
    <title>Code coverage report for massive-js/lib/table.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">massive-js/lib</a> table.js
    </h1>
    <div class='clearfix'>
 ...
 */
Table.prototype.getPkCriteria = function (record) {
  let missing = false;
&nbsp;
...
&nbsp;
  if (criteria) {
    const update = new Update(this, {body: _.omit(doc, this.pk)}, criteria, options);
&nbsp;
    return this.db.query(update);
  }
&nbsp;
...
&nbsp;
  const sql = `UPDATE ${this.delimitedFullName} SET "${field}"="${field}" || $1 WHERE ${queryCriteria.conditions} RETURNING *;`;
&nbsp;
